				...
				<div align="center">
					...
					<s:form action="RoleAction_saveOrUpdateRole" namespace="/"
						...
						<table class="table-class">
							<tr>
								<th>角色名称:</th>
								<td><input type="text" name="roleName" id="role-name" /></td>
							</tr>
							<tr>
								<th>角色属性值:</th>
								<td><input type="text" name="roleValue" id="role-value" /></td>
							</tr>
							<tr>
								<th>角色描述:</th>
								<td><input type="text" name="roleDesc" id="role-desc" /></td>
							</tr>
							<tr>
