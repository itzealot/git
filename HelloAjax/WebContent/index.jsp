...
<body>
	...
	<a href="${pageContext.request.contextPath }/send-html/send-html.jsp">Send HTML</a>
	<br /><br />
	
	<a href="${pageContext.request.contextPath }/send-xml/send-xml.jsp">Send XML</a>
	<br /><br />
	
	<a href="${pageContext.request.contextPath }/json/json.jsp">Json</a>
	<br /><br />
	
	<a href="${pageContext.request.contextPath }/json/send-json.jsp">Send Json</a>
	<br /><br />
